...
for table in range(0,len(sectionTables)):
	...
	for i in range(0,len(dbData)):
		...
		#print(currentEntry)
		jsonData.append({"title":currentEntry[1],"body":currentEntry[2],"category":currentEntry[3],"link":currentEntry[4],"previousTitle":currentEntry[5],"previousLink":currentEntry[6],"nextTitle":currentEntry[7],"nextLink":currentEntry[8],"externalLinks":currentEntry[9],"date":currentEntry[10]})
